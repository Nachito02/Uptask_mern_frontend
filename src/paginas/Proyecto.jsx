...
const Proyecto = () => {
  ...
  useEffect(()=>{
    ...
    socket.on('nuevo estado', neuvoEstadoTarea => {
      if(neuvoEstadoTarea.proyecto._id === proyecto._id) {
        cambiarEstadoTarea(neuvoEstadoTarea)
      }
    })
  })
  ...
  return  (
    <>
      ...
      <div className="flex justify-center">
        <div className="md:full lg:w-1/4"></div>
      </div>
