  ...
  return (
    ...
    <div className='my-5'>
      ...
      <div className='my-5'>
        ...
        id="password2"
          type="password"
          placeholder="Repeti tu passowrd"
          className='w-full mt-3 p-3 border rounded-xl bg-gray-50'
      ...
      <input type="submit" value="Registrarse" className="bg-sky-700 mb-5 w-full py-3 text-white uppercase font-bold rounded text-center hover:cursor-pointer hover:bg-sky-800 transition-colors" />
    </form>
